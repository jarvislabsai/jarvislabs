...
def _show_getting_started() -> None:
    ...
    instance_text.append("jl instance create --gpu A100 --storage 50\n", style="bold")
    instance_text.append("List      ", style=_MUTED)
    instance_text.append("jl instance list\n", style="bold")
    instance_text.append("Pause     ", style=_MUTED)
    instance_text.append("jl instance pause <id>", style="bold")
    instance_text.append("       stops billing, keeps storage\n", style=_MUTED)
    instance_text.append("Resume    ", style=_MUTED)
    instance_text.append("jl instance resume <id>", style="bold")
    instance_text.append("      pick up where you left off\n", style=_MUTED)
    instance_text.append("Destroy   ", style=_MUTED)
    instance_text.append("jl instance destroy <id>", style="bold")
    ...
    quick.append("   help for any command", style=_MUTED)
